...
:::tip
libSQL is the easiest way to get started because it doesn’t require running a separate database server. For help choosing the right database for your needs, see the [Choosing a Database](/docs/deployment/choosing-a-database) guide.
:::
