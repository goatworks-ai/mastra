...
:::tip
Before deploying, choose a database for your application. See the [Choosing a Database](/docs/deployment/choosing-a-database) guide for recommendations based on your deployment environment and requirements.
:::
